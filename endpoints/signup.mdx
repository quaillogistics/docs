...
Create a new account and receive an API key. Email and password are required; the password is used to log in later and is also the credential needed for [password resets](/endpoints/forgot-password) and [API-key regeneration](/endpoints/account).
